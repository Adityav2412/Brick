        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="bg-primary rounded-3xl p-4 flex flex-col gap-2 shadow-warm">
            ...
            <div>
              ...
              <p className="text-xs text-primary-foreground/70 font-medium">Today's Rhythm</p>
            </div>
          </div>
          ...
          <div className="bg-card rounded-3xl border border-border p-4 flex flex-col gap-2">
            ...
            <div>
              <p className="font-heading text-3xl text-foreground">{totalLecturesDone}</p>
          ...
          <div className="bg-card rounded-3xl border border-border p-4 flex flex-col gap-2">
            ...
            <div>
              <p className="font-heading text-3xl text-foreground">{remainingLectures}</p>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              {subjectProgress.map(({ subject, total, done }) => {
                ...
                return (
                  <div key={subject.id} className="bg-card rounded-3xl border border-border p-4">
